...
$("#cryptoSelect").change(() => {
	...
	<div class="tradingview-widget-container">
	  ...
	  <div class="tradingview-widget-copyright"><a href="https://es.tradingview.com/symbols/${cryptoSeleccion}${cryptoSeleccion2}/?exchange=COINBASE" rel="noopener" target="_blank"><span class="blue-text">Gráfico</span></a> por TradingView</div>
	  <script type="text/javascript" src="https://s3.tradingview.com/tv.js"></script>
	  <script type="text/javascript">
	  new TradingView.widget(
	  {
	  "autosize": true,
	  "symbol": "COINBASE:${cryptoSeleccion}${cryptoSeleccion2}",
	  "interval": "60",
	  "timezone": "Etc/UTC",
	  "theme": "light",
	  "style": "1",
